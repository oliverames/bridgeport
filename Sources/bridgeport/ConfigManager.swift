...
public actor ConfigManager {
    ...
    public static func connectorIconCandidateURLs(for connector: Connector) -> [URL] {
        ...
        return [
            ...
            directoryURL.appendingPathComponent("assets/logo.png"),
            directoryURL.appendingPathComponent("assets/logo.svg"),
            directoryURL.appendingPathComponent("images/icon.png"),
            directoryURL.appendingPathComponent("images/icon.svg"),
            directoryURL.appendingPathComponent("images/logo.png"),
            directoryURL.appendingPathComponent("images/logo.svg"),
            directoryURL.appendingPathComponent("public/icon.png"),
            directoryURL.appendingPathComponent("public/icon.svg"),
            directoryURL.appendingPathComponent("icon.png"),
            directoryURL.appendingPathComponent("icon.svg"),
            directoryURL.appendingPathComponent("logo.png"),
            directoryURL.appendingPathComponent("logo.svg"),
